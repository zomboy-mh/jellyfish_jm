					...
					<view class="wh flex-vertical position-r">
						<view class="line-height25 padding-bottom-50">
							<view class="font-20 font-bold">
								<span v-for="(items,indexs) in bookName" :key="indexs" @tap="tranbtn(items)">
									{{items + ' '}}
								</span>
							</view>
				...
				<view class="height flex justify-center align-center padding-top-20">
					<view class="cot_img position-r">
						...
						<image class="wh bg-white radius-9"
							:src="formalUrl + swiperList[swiperCurrent].pagePicfile + '?x-oss-process=style/w630h600'"
							mode="aspectFit">
						</image>
					</view>
					<view class="cot_article margin-left">
						<view class="wh flex-vertical hidden scroll">
							<view class="line-height25 padding-bottom-50">
								...
								<view class="text_left" v-if="swiperCurrent == 0">
									...
									<view v-if="swiperCurrent == 0"  class=" font-18 margin-top-10 "
								...
								<view :class="swiperList[swiperCurrent].lengthif? 'text_left_box2':'text_left_box1'"
									v-if="swiperCurrent > 0">
									<view class="font-20 text_item" 
				...
				<swiper-item v-for="(item,index) in swiperList" :key="index">
					<view class="height flex justify-center align-center padding-top-20">
						<view class="cot_img position-r">
							...
							<image class="wh bg-white radius-9"
								:src="formalUrl + item.pagePicfile + '?x-oss-process=style/w630h600'" mode="aspectFit">
							</image>
						</view>
						<view class="cot_article margin-left">
							<view class="wh flex-vertical hidden scroll">
								<view class="line-height25 padding-bottom-50">
									...
									<view :class="item.lengthif? 'text_left_box2':'text_left_box1'" v-if="index > 0">
										<view class="font-20 text_item" 
...
<script>
	import pageIndex from '@/components/page-index.vue';
	 ...
	 import {getBookPage,pushBookRecord,chivoxParam} from '../../api/index.js'
	...
	export default {
		...
		data() {
			return {
				imageUrl: imageUrl,
				formalUrl:formalUrl,
				mRightVoice: this.$imageUrl + "audio/right.mp3",
